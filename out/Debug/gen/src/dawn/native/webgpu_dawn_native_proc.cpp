...
extern WGPUTextureUsage NativeDeviceGetSupportedSurfaceUsage(WGPUDevice cSelf, WGPUSurface surface);
...
extern "C" {
    ...
    WGPUTextureUsage wgpuDeviceGetSupportedSurfaceUsage(WGPUDevice cSelf, WGPUSurface surface) {
