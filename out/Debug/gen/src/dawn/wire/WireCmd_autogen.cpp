...
DAWN_DECLARE_UNUSED size_t WGPUShaderModuleWGSLDescriptorGetExtraRequiredSize(const WGPUShaderModuleWGSLDescriptor& record) {
    ...
    bool has_source = record.source != nullptr;
    if (has_source)
    {
    result += Align(std::strlen(record.source), kWireBufferAlignment);
    }

    bool has_code = record.code != nullptr;
    if (has_code)
    {
...
DAWN_DECLARE_UNUSED WireResult WGPUShaderModuleWGSLDescriptorSerialize(
    ...
    bool has_source = record.source != nullptr;
    transfer->has_source = has_source;
    if (has_source)
    {
...
DAWN_DECLARE_UNUSED WireResult WGPUShaderModuleWGSLDescriptorDeserialize(
    ...
    bool has_source = transfer->has_source;
    ...
    bool has_code = transfer->has_code;
    record->code = nullptr;
    if (has_code)
    {
